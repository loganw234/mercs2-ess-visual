...
(function () {
  ...
  // itself). Copied locally rather than centralized in codegen.js -- see nodes-markers-camera.js's header
  // for why this helper is intentionally duplicated per-file in this repo.
